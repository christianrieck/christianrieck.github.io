    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-our-two-papers-39-visualizing-the-cg-community-and-sliding-cubes-in-parallel-have-been-accepted-as-media-expositions-at-socg-2026",
          title: 'Our two papers &amp;#39;’Visualizing’’ the CG community and Sliding cubes in parallel have...',
          description: "",
          section: "News",},{id: "news-three-of-our-papers-have-been-accepted-segment-watchman-routes-has-been-accepted-to-mfcs-2026-structural-properties-of-shortest-flip-sequences-between-plane-spanning-trees-has-been-accepted-to-gd-2026-and-sliding-cubes-in-parallel-has-been-accepted-to-esa-2026",
          title: 'Three of our papers have been accepted: Segment watchman routes has been accepted...',
          description: "",
          section: "News",},{id: "news-our-paper-coordinated-motion-planning-multi-agent-path-finding-in-a-densely-packed-bounded-domain-is-now-published-in-autonomous-agents-and-multi-agent-systems",
          title: 'Our paper Coordinated motion planning: Multi-agent path finding in a densely packed, bounded...',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://dblp.uni-trier.de/pid/206/6818.html", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=Mz7GqoIAAAAJ", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0000-0003-0846-5163", "_blank");
        },
      },{
        id: 'social-arxiv',
        title: 'arXiv',
        section: 'Socials',
        handler: () => {
          window.open("https://arxiv.org/a/rieck_c_1.html", "_blank");
        },
      },{
      id: 'light-theme',
